  ...
  <div class="h-full flex flex-wrap justify-center content-center">
    <div class="px-4 md:px-10 text-center bg-white rounded py-12 rounded shadow-md">
      ...
      <div class="pt-5 flex justify-center">
        <router-link class="btn bg-teal-500 hover:bg-teal-700 text-white mr-5 shadow-md" to="/Register">Try it out!</router-link>
        <router-link class="btn bg-indigo-500 hover:bg-indigo-700 text-white shadow-md" to="/Login">Login</router-link>      
      </div>
    </div>
  </div>
</template>
